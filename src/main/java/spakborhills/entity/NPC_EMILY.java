...
public class NPC_EMILY extends NPC {
    ...
    public void initializeShopInventory() {
        ...
        shopInventory
                .add(new OBJ_Seed(gp, ItemType.SEEDS, "Parsnip", false, 20, 10, 1, 1, Season.SPRING, Weather.RAINY));
        shopInventory.add(
                new OBJ_Seed(gp, ItemType.SEEDS, "Cauliflower", false, 80, 40, 2, 5, Season.SPRING, Weather.SUNNY)); // Assuming
                                                                                                                     // sunny
                                                                                                                     // default
                                                                                                                     // for
                                                                                                                     // simplicity
        shopInventory
                .add(new OBJ_Seed(gp, ItemType.SEEDS, "Potato", false, 50, 25, 2, 3, Season.SPRING, Weather.SUNNY));
        shopInventory.add(new OBJ_Seed(gp, ItemType.SEEDS, "Wheat", false, 60, 30, 2, 1, Season.SPRING, Weather.SUNNY)); // Spring/Fall,
                                                                                                                         // using
                                                                                                                         // Spring
        shopInventory
                .add(new OBJ_Seed(gp, ItemType.SEEDS, "Blueberry", false, 80, 40, 2, 7, Season.SUMMER, Weather.SUNNY));
        shopInventory
                .add(new OBJ_Seed(gp, ItemType.SEEDS, "Tomato", false, 50, 25, 2, 3, Season.SUMMER, Weather.SUNNY));
        shopInventory
                .add(new OBJ_Seed(gp, ItemType.SEEDS, "Hot Pepper", false, 40, 20, 2, 1, Season.SUMMER, Weather.SUNNY));
        shopInventory.add(new OBJ_Seed(gp, ItemType.SEEDS, "Melon", false, 80, 40, 2, 4, Season.SUMMER, Weather.SUNNY));
        shopInventory
                .add(new OBJ_Seed(gp, ItemType.SEEDS, "Cranberry", false, 100, 50, 2, 2, Season.FALL, Weather.SUNNY));
        shopInventory
                .add(new OBJ_Seed(gp, ItemType.SEEDS, "Pumpkin", false, 150, 75, 2, 7, Season.FALL, Weather.SUNNY));
        // Wheat for Fall is the same as Spring, already added.
        shopInventory.add(new OBJ_Seed(gp, ItemType.SEEDS, "Grape", false, 60, 30, 2, 3, Season.FALL, Weather.SUNNY));
        ...
        // Fugu has no buy price in PDF table, so not added.
